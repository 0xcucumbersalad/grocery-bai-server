...
const { validateItem, validateUpdateItem } = require("../utils/fieldValidation")
...
router.post("/user/items", authenticateToken, async(req,res) => {
     try {
...
router.put("/user/items", authenticateToken, async(req, res) => {
     try {
